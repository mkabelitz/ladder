...
NOISE_STD = 0.45  # Noise standard deviation for Gaussian noise applied to layers
...
FILE_NAME = '100_labels_supervised_only.py'
...
SESSION_PATH = "./logs/"
VERSION_PATH = SESSION_PATH + '100_labels_supervised_only/'
