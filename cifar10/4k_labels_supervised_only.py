...
LR_DECAY_FIRST = 0.5  # Percentage of epochs after which to start learning rate decay
...
FILE_NAME = '4k_labels_supervised_only.py'
...
SESSION_PATH = "./logs/"
VERSION_PATH = SESSION_PATH + '4k_labels_supervised_only/'
