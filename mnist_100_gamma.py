...
def main(_):
    ...
    with tf.variable_scope('model') as scope:
        logits_tr, _, _ = models.mnist_gamma(data_tr_batch, is_training=True, is_unlabeled=False, ema=ema)
        scope.reuse_variables()
        _, crt, cln = models.mnist_gamma(unlabeled_batch, is_training=True, is_unlabeled=True, ema=ema)
        logits_te, _, _ = models.mnist_gamma(data_te_batch, is_training=False,  is_unlabeled=False, ema=ema)
